...
/**
 * Tests the behavior of the driver when some hosts have no rpc_address in the control host's system
 * tables (JAVA-428).
 *
 * <p>This can happen because of gossip bugs. We want to ignore these hosts because this is most
 * likely indicative of an error state.
 */
